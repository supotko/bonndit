...
static void __pyx_f_7bonndit_5utilc_5myext_mw_openmp_mult_o6(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_signal, __Pyx_memviewslice __pyx_v_est_signal, __Pyx_memviewslice __pyx_v_dipy_v, __Pyx_memviewslice __pyx_v_pysh_v, __Pyx_memviewslice __pyx_v_rot_pysh_v, __Pyx_memviewslice __pyx_v_angles_v, __Pyx_memviewslice __pyx_v_loss, int __pyx_v_amount, int __pyx_v_num_of_dir, int __pyx_v_no_spread) {
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
...
static void __pyx_f_7bonndit_5utilc_5myext_mw_openmp_mult_o8(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_signal, __Pyx_memviewslice __pyx_v_est_signal, __Pyx_memviewslice __pyx_v_dipy_v, __Pyx_memviewslice __pyx_v_pysh_v, __Pyx_memviewslice __pyx_v_rot_pysh_v, __Pyx_memviewslice __pyx_v_angles_v, __Pyx_memviewslice __pyx_v_loss, int __pyx_v_amount, int __pyx_v_num_of_dir, int __pyx_v_no_spread) {
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "bonndit.utilc.myext")) {
      if (unlikely(PyDict_SetItemString(modules, "bonndit.utilc.myext", __pyx_m) < 0)) __PYX_ERR(2, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * np.import_array()
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np, __pyx_t_1) < 0) __PYX_ERR(2, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
