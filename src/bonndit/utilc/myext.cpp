 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(init_python()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
...
static PyObject *__pyx_pw_7bonndit_5utilc_5myext_3mw_openmp_mult(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("mw_openmp_mult (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_signal)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 1); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_est_signal)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 2); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dipy_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 3); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pysh_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 4); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rot_pysh_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 5); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_angles_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 6); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dj)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 7); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_loss)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 8); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_amount)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 9); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lmax)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 10); __PYX_ERR(0, 45, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_of_dir)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, 11); __PYX_ERR(0, 45, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "mw_openmp_mult") < 0)) __PYX_ERR(0, 45, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_signal = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_signal.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_est_signal = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_est_signal.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_dipy_v = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_dipy_v.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_pysh_v = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_pysh_v.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_rot_pysh_v = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rot_pysh_v.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_angles_v = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_angles_v.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_dj = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_dj.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_loss = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_loss.memview)) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_amount = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_amount == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_lmax = __Pyx_PyInt_As_int(values[10]); if (unlikely((__pyx_v_lmax == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
    __pyx_v_num_of_dir = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_num_of_dir == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 45, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mw_openmp_mult", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 45, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pw_7bonndit_5utilc_5myext_5getdjp(PyObject *__pyx_self, PyObject *__pyx_arg_dj_c) {
  ...
  assert(__pyx_arg_dj_c); {
    __pyx_v_dj_c = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_arg_dj_c, PyBUF_WRITABLE); if (unlikely(!__pyx_v_dj_c.memview)) __PYX_ERR(0, 134, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
 ...
 *                 minimize_watson_mult(&x[0,0],&signal[0,0],&est_signal[0,0],&dipy_v[0,0],&pysh_v[0,0,0,0],&rot_pysh_v[0,0,0,0],&angles_v[0,0],&dj[0,0,0],&loss[0],amount,lmax,num_of_dir)
 */
  __pyx_tuple__22 = PyTuple_Pack(12, __pyx_n_s_x, __pyx_n_s_signal, __pyx_n_s_est_signal, __pyx_n_s_dipy_v, __pyx_n_s_pysh_v, __pyx_n_s_rot_pysh_v, __pyx_n_s_angles_v, __pyx_n_s_dj, __pyx_n_s_loss, __pyx_n_s_amount, __pyx_n_s_lmax, __pyx_n_s_num_of_dir); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(12, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_bonndit_utilc_myext_pyx, __pyx_n_s_mw_openmp_mult, 45, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 *         getdj(&dj_c[0,0,0])
 */
  __pyx_tuple__24 = PyTuple_Pack(2, __pyx_n_s_dj_c, __pyx_n_s_dj_c); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_bonndit_utilc_myext_pyx, __pyx_n_s_getdjp, 134, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 134, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7bonndit_5utilc_5myext_1init_py, NULL, __pyx_n_s_bonndit_utilc_myext); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_init_py, __pyx_t_1) < 0) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *                 minimize_watson_mult(&x[0,0],&signal[0,0],&est_signal[0,0],&dipy_v[0,0],&pysh_v[0,0,0,0],&rot_pysh_v[0,0,0,0],&angles_v[0,0],&dj[0,0,0],&loss[0],amount,lmax,num_of_dir)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7bonndit_5utilc_5myext_3mw_openmp_mult, NULL, __pyx_n_s_bonndit_utilc_myext); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mw_openmp_mult, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         getdj(&dj_c[0,0,0])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7bonndit_5utilc_5myext_5getdjp, NULL, __pyx_n_s_bonndit_utilc_myext); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_getdjp, __pyx_t_1) < 0) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
